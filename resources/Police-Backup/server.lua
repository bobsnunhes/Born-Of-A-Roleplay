...
if Config.usecommand then
  RegisterCommand("bk", function(source, args, rawCommand)
      ...
      if not bkLvl then
          TriggerClientEvent("Fax:ShowInfo", source, "~y~Por favor especifique o nível do código: ~n~~s~1, 2, 3")
      elseif bkLvl == "1" then
      ...
      elseif bkLvl ~= "1" or bkLvl ~= "2" or bkLvl ~= "3" or bkLvl ~= "99" then
          TriggerClientEvent("Fax:ShowInfo", source, "~y~Nível de código inválido")
      end
  end)
end
