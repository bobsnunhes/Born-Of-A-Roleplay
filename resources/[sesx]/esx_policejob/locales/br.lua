Locales['br'] = {
  ...
  ['license_revoked'] = 'Sua ~b~%s~s~ foi ~y~revoked~s~!',
  ...
  ['you_confiscated_weapon'] = 'Você ~b~%s~s~ de ~b~%s~s~ com ~o~%s~s~ balas',
  ['got_confiscated_weapon'] = 'Você ~b~%s~s~ com ~o~%s~s~ balas foi confiscada por ~y~%s~s~',
