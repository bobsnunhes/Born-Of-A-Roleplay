Locales['en'] = {
  ...
  ['thelostmcnotexit_wear'] = 'TheLostMC Outfit',
  ...
  ['open_cloackroom'] = '~g~press ~INPUT_CONTEXT~ ~y~to change',
  -- Armory
  ...
  ['vehicle_spawner'] = '~g~press ~INPUT_CONTEXT~ ~y~to take out a vehicle',
  ['store_vehicle'] = '~g~press ~INPUT_CONTEXT~ ~y~to store the vehicle',
  ...
  -- Misc
  ['remove_object'] = '~g~press ~INPUT_CONTEXT~ ~y~to delete the object',
  ['map_blip'] = 'TheLostMC',
  -- Notifications
  ['from'] = '~s~ from ~b~',
  ...
  ['alert_thelostmc'] = 'Alerta do Motoclube',
}
