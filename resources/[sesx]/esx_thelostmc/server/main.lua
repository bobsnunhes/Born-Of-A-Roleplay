print('TheLostMC successfully loaded!')
...
ESX.RegisterServerCallback('esx_thelostmcjob:getFineList', function(source, cb, category)

  MySQL.Async.fetchAll(
    'SELECT * FROM fine_types_thelostmc WHERE category = @category',
    {
      ['@category'] = category
    },
    function(fines)
