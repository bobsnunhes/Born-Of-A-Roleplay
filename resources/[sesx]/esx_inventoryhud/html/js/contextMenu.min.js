    ...
    e.fn.contextMenu = function(t, n) {
            ...
            f = function(n) {
                var o = n || t,
                    ...
                    s = e(
                        '<div id="' +
                        i +
                        '" class="site-cm-box" style="position:absolute; display: none;">'
                    );
                        ...
                        e.each(n, function(n, i) {
                            var l,
                                u = e(
                                    "<li>" +
                                    i.text +
                                    (e.isArray(i.items) && i.items.length ? f(i.items) : "") +
                                    "</li>"
                                );
                            e.isFunction(i.action) &&
                                (
                                    (a[(l = c + "_" + r + "_" + t + "_" + n)] = i.action),
                                    u.attr("data-key", l)
                                ), o.append(u).appendTo(s);
                        });
                    }
                });
        ...
        return o.on("mousedown", function(t) {
            ...
            e(this).on("contextmenu", function(t) {
                (e.isFunction(s.beforeShow) && !1 === s.beforeShow.call(this, t)) ||
                (
                    (t.cancelBubble = !0),
                    t.preventDefault(),
                    (function() {
