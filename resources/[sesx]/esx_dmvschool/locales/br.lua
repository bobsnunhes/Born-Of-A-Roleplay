Locales['br'] = {
  ...
  ['stop_look_left'] = '~r~Pare~s~ e olhe para ~y~esquerda~s~. Limite de velocidade: ~y~%s~s~ km/h',
  ...
  ['gratz_stay_alert'] = 'Estou impressionado, mas não se esqueça de ficar ~r~alerta~s~ enquanto está dirigindo!',
  ['passed_test'] = 'você ~g~passou~s~ no teste, parabéns!',
  ['failed_test'] = 'você ~r~falhou~s~ no teste, boa sorte da próxima vez!',
  ['theory_test'] = 'teste teórico de condução',
  ['road_test_car'] = 'Teste Prático - Carro',
  ['road_test_bike'] = 'Teste Prátíco - Moto',
  ['road_test_truck'] = 'Teste Prátíco - Caminhão',
