...
AddEventHandler("tattoos:save", function(tattoosList, price, value)
	...
	if(xPlayer.getMoney() >= price) then
		...
		TriggerClientEvent("esx:showNotification", _source, "~g~Você comprou a tatuagem.")
	else
		TriggerClientEvent("esx:showNotification", _source, "~r~Você não tem dinheiro suficiente.")
	end
end)
