Locales['br'] = {
  ...
  ['ems_clothes_ems'] = 'Uniforme de trabalho',
  -- Vehicles
  ['ambulance'] = 'Ambulância',
  ['helicopter_prompt'] = 'Pressione ~INPUT_CONTEXT~ para acessar as ~y~Ações de Helicóptero~s~.',
  ['helicopter_buy'] = 'Solicitação de Helicóptero',
  ['helicopter_garage'] = 'Abrir Heliporto',
  ['helicopter_store'] = 'Guardar Helicóptero',
  ['helicopter_garage_title'] = 'Heliporto',
  ['helicopter_title'] = 'Helicópteros',
  ['helicopter_notauthorized'] = 'Você não está autorizado a solicitar helicópteros.',
  ['garage_prompt'] = 'Pressione ~INPUT_CONTEXT~ para acessar as ~y~viaturas~s~.',
  ['garage_title'] = 'Viaturas',
  ['garage_stored'] = 'Guardado',
  ['garage_notstored'] = 'Não está na garagem',
  ['garage_storing'] = 'Estamos prestes a remover o veículo, tenha certeza que não há ninguém por perto.',
  ['garage_has_stored'] = 'O veículo foi guardado em sua garagem',
