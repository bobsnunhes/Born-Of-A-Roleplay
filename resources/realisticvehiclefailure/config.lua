...
repairCfg = {
	...
	fixMessages = {
		"Você verificou a tampa de óleo",
		"Você reparou o vazamento de óleo usando um chiclete",
		"Você reparou a mangueira de óleo com uma fita isolante",
		"Você apertou o parafuso do carter e parou o vazamento",
		"Você chutou o motor e voltou a funcionar",
		"Você retirou a poeira da vela de ignição",
		"Você gritou dentro do veículo, e de alguma maneira isso teve efeito"
	},
	fixMessageCount = 7,

	noFixMessages = {
		"Você verificou a tampa de óleo. Ainda está ali.",
		"Você olhou para o motor e tudo parece bem.",
		"A fita isolante ainda está segurando as pontas.",
		"Você aumentou o volume do rádio. Só para não ouvir o barulho estanho do motor",
		"Você adicionou um protetor de poeira na vela de ignição. E não fez diferença.",
		"Nunca arrume algo que não está quebrado, dizem por ai. Você não escutou. Ao menos não ficou pior."
	},
	noFixMessageCount = 6
}
