...
local HUD = {
	...
	RaceMode		= true, 	-- Enables/Disables The Race Mode HUD
			...
			if HUD.SeatBelt and PedBike == false and PedHeli == false and PedPlane == false and PedBoat == false then
				...
				if car ~= 0 and (wasInCar or IsCar(car)) then
					...
					speedBuffer[1] = GetEntitySpeed(car)
						...
						if beltOn then
							drawTxt(UI.x + 0.545, UI.y + 1.245, 1.0,1.0,0.45, "CINTO DE SEGURANÇA", 0, 255, 0,200) -- Green
						else
							drawTxt(UI.x + 0.545, UI.y + 1.245, 1.0,1.0,0.45, "CINTO DE SEGURANÇA", 255, 0, 0,200) -- Red
						end
